...
const Card = ({ WeatherInfo }) => {
  ...
  return (
    <center className="flex justify-between space-x-10">
      <div className='bg-[url("../images/5.png")] bg-cover bg-center h-80 rounded-xl text-white flex justify-between space-x-20 p-5'>
        <div className="w-1/2 ">
          <h1 className="text-7xl w-96 text-black">
            {Data ? (Data.main.temp - 273.15).toPrecision(4) : 0}&deg;C
          </h1>{" "}
          <br />
        ...
        <div className="w-1/2">
          <center className="mx-0 text-3xl font-bold">
